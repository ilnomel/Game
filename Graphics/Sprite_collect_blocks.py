...
class Block(pygame.sprite.Sprite):
    ...
    # Reposition block to the top
    def reset_pos(self):
        """
        Rest poisition to the top of the screen, at a random x location.
...
while not done:
    ...
    # Call update() method on every sprite in the lsit
